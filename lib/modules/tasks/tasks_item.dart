...
class _TasksItemState extends State<TasksItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: widget.taskmodel.isDone == false
          ? (() {
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                      ...
                      child: doneTasks(widget.taskmodel.isDone)),
                ],
              ),
            ),
          ),
  ...
  Widget? doneTasks(bool isDone) {
    if (isDone == false) {
      return Container(
        width: 60,
        height: 30,
        decoration: BoxDecoration(
            color: MyTheme.pryColor, borderRadius: BorderRadius.circular(8)),
        child: Icon(
          Icons.check,
